                    ...
                    VStack{
                        HStack{
                            Image("m2").padding(.leading,10)
                                .padding(.top,10)
                            Text("Emily R.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("May 10, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("A thrilling adventure! The mine setting felt so real, and the puzzles were challenging.")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
                    ...
                    VStack{
                        HStack{
                            Image("m1").padding(.leading,10)
                                .padding(.top,10)
                            Text("Michael S.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("June 5, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("We had a blast! The attention to detail in the room was impressive.")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
