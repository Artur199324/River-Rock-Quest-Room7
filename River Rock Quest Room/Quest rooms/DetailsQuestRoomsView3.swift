                    ...
                    VStack{
                        HStack{
                            Image("m2").padding(.leading,10)
                                .padding(.top,10)
                            Text("Sarah L.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("July 20, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("A mind-bending experience! The futuristic elements were so well done.")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
                    ...
                    VStack{
                        HStack{
                            Image("m1").padding(.leading,10)
                                .padding(.top,10)
                            Text("David K.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("August 15, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("Challenging puzzles with a cool sci-fi vibe. Highly recommend!")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
