                    ...
                    VStack{
                        HStack{
                            Image("m2").padding(.leading,10)
                                .padding(.top,10)
                            Text("Amelia P.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                        ...
                        Text("This room had me on edge! The submarine setting was so realistic, and the puzzles were challenging but fun.")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
                    ...
                    VStack{
                        HStack{
                            Image("m1").padding(.leading,10)
                                .padding(.top,10)
                            Text("Ethan L.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                        ...
                        Text("A great mix of teamwork and problem-solving. We barely escaped in time!")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
