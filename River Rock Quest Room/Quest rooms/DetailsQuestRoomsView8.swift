                    ...
                    VStack{
                        HStack{
                            Image("m2").padding(.leading,10)
                                .padding(.top,10)
                            Text("Sophia L.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("June 12, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("A great mix of suspense and action. We felt like real secret agents!")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
                    ...
                    VStack{
                        HStack{
                            Image("m1").padding(.leading,10)
                                .padding(.top,10)
                            Text("Chris R.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("May 18, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("his escape room is like being in a spy movie! The tech puzzles were next-level fun.")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
