                    ...
                    VStack{
                        HStack{
                            Image("m2").padding(.leading,10)
                                .padding(.top,10)
                            Text("Alice M.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("April 2, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("An enchanting experience! The puzzles were well-designed, and the atmosphere was immersive.")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
                    ...
                    VStack{
                        HStack{
                            Image("m1").padding(.leading,10)
                                .padding(.top,10)
                            Text("John D.").foregroundColor(.white).padding(.leading,10)
                            Spacer()
                            Text("April 2, 2024")
                                .foregroundColor(Color("myc2"))
                                .padding(.trailing,10)
                        ...
                        Text("A must-visit for fantasy lovers. The storyline kept us engaged throughout.")
                            .padding(.bottom,10)
                            .foregroundColor(.white)
                            .padding()
                    }.frame(maxWidth: .infinity)
